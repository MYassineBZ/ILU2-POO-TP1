...
public class Etal {
	...
	public String acheterProduit(int quantiteAcheter, Gaulois acheteur) {
		if (quantiteAcheter < 1) {
			throw new IllegalArgumentException("La quantite achete doit etre positive\n");
		}
		try {
			acheteur.getNom();
		} catch (Exception e) {
			throw new IllegalStateException("l'acheteur ne doit pas etre null");
		}
		try {
			vendeur.getNom();
		} catch (Exception e2) {
			throw new IllegalStateException("L'etal doit etre occupe par un vendeur");
		}
